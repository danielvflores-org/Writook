...
class RedefineStoryParametersTest {
    ...
    void testRedefineTitle() {
        User author = new User("danielvflores", null, "daniel@email.com", "hashPassword", "Daniel V. Flores", "A passionate writer.", "http://profile.url/image.jpg");
        ...
        Story original = new Story("Título A", "Sinopsis", authorDTO, 4.5, genres, tags, chapters, null);
        Story modificado = new Story("Título B", original.getSynopsis(), original.getAuthor(), original.getRating(), original.getGenres(), original.getTags(), original.getChapters(), original.getId());
